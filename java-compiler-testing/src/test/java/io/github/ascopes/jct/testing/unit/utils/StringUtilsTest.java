...
class StringUtilsTest implements StaticClassTestTemplate {
  ...
  static Stream<Arguments> iterableCases() {
    return Stream.of(
        ...
        of(List.class, Arrays.combineOneOrMore(null, null), "[null, null]"),
        of(List.class, Arrays.combineOneOrMore(null, null, null), "[null, null, null]"),
        of(List.class, Arrays.combineOneOrMore(null, true, null), "[null, \"true\", null]"),
