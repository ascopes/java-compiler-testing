...
class AbstractJctCompilerTest {
  ...
  class LocaleTests {
    ...
    @MethodSource("io.github.ascopes.jct.compilers.AbstractJctCompilerTest#locales")
    @ParameterizedTest(name = "for locale = {0}")
  ...
  class LogCharsetTests {
    ...
    @MethodSource("io.github.ascopes.jct.compilers.AbstractJctCompilerTest#charsets")
    @ParameterizedTest(name = "for logCharset = {0}")
