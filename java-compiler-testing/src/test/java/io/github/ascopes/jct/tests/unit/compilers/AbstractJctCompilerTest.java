...
class AbstractJctCompilerTest {
  ...
  void compileReturnsTheExpectedObject() {
    try (var factoryCls = mockStatic(JctCompilationFactory.class)) {
      // Given
      var expectedCompilation = mock(JctCompilationImpl.class);
      factoryCls.when(() -> JctCompilationFactory.compile(any(), any(), any(), any()))
      ...
      // Then
      factoryCls.verify(() -> JctCompilationFactory
