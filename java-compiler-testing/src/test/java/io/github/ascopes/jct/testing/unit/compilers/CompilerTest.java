...
class CompilerTest {
  ...
  void varargOverloadForAddPathsCallsCorrectMethod() {
    ...
    var location = MoreMocks.stub(Location.class);
    var path1 = MoreMocks.stub(Path.class);
    var path2 = MoreMocks.stub(Path.class);
    var path3 = MoreMocks.stub(Path.class);
  ...
  void addClassOutputPathsWithIterableCallsAddPaths() {
    ...
    given(compiler.addPaths(any(), any())).will(ctx -> compiler);
    var paths = MoreMocks.stubCast(new TypeRef<Collection<Path>>() {});
  ...
  void varargOverloadForAddClassOutputPathsCallsVarargsOverloadsAddPaths() {
    // Given
    var firstPath = MoreMocks.stub(Path.class);
    var secondPath = MoreMocks.stub(Path.class);
    var thirdPath = MoreMocks.stub(Path.class);
  ...
  void varargOverloadForAddRamPathsCallsCorrectMethod() {
    ...
    var location = MoreMocks.stub(Location.class);
    var ramPath1 = MoreMocks.stub(RamPath.class);
    var ramPath2 = MoreMocks.stub(RamPath.class);
    var ramPath3 = MoreMocks.stub(RamPath.class);
  ...
  void addClassOutputRamPathsWithIterableCallsAddPaths() {
    ...
    given(compiler.addRamPaths(any(), any())).will(ctx -> compiler);
    var ramPaths = MoreMocks.stubCast(new TypeRef<Collection<RamPath>>() {});
  ...
  void varargOverloadForAddClassOutputRamPathsCallsVarargsOverloadsAddPaths() {
    // Given
    var firstRamPath = MoreMocks.stub(RamPath.class);
    var secondRamPath = MoreMocks.stub(RamPath.class);
    var thirdRamPath = MoreMocks.stub(RamPath.class);
  ...
  void varargOverloadForAddAnnotationProcessorsCallsCorrectMethod() {
    ...
    var firstProc = MoreMocks.stub(Processor.class);
    var secondProc = MoreMocks.stub(Processor.class);
    var thirdProc = MoreMocks.stub(Processor.class);
