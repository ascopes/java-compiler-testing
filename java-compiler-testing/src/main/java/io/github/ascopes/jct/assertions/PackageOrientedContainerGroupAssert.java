...
/**
 * Base methods to provide for a {@link PackageOrientedContainerGroup} assertion type.
 *
 * @author Ashley Scopes
 * @since 0.0.1
 */
@API(since = "0.0.1", status = Status.EXPERIMENTAL)
public class PackageOrientedContainerGroupAssert
    extends AbstractAssert<PackageOrientedContainerGroupAssert, PackageOrientedContainerGroup> {
   ...
   */
  public PackageOrientedContainerGroupAssert(PackageOrientedContainerGroup actual) {
    super(actual, PackageOrientedContainerGroupAssert.class);
  }
   ...
   */
  public PackageOrientedContainerGroupAssert isEmpty() {
    if (!actual.isEmpty()) {
      throw failure(
   ...
   * @return this assertion object for further call chaining.
   */
  public PackageOrientedContainerGroupAssert isNotEmpty() {
    if (actual.isEmpty()) {
      throw failure(
