...
/**
 * Base methods to provide for a {@link ModuleContainerGroup} assertion type.
 *
 * @author Ashley Scopes
 * @since 0.0.1
 */
@API(since = "0.0.1", status = Status.EXPERIMENTAL)
public class ModuleContainerGroupAssert
    extends AbstractAssert<ModuleContainerGroupAssert, ModuleContainerGroup> {
   ...
   */
  public ModuleContainerGroupAssert(ModuleContainerGroup actual) {
    super(actual, ModuleContainerGroupAssert.class);
  }
   ...
   */
  public ModuleContainerGroupAssert isEmpty(String moduleName) {
   ...
   * @return this assertion object for further call chaining.
   */
  public ModuleContainerGroupAssert isNotEmpty(String moduleName) {
