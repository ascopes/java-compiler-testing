...
package com.github.ascopes.jct.examples.lombok;
...
class LombokIntegrationTest {
  ...
  void lombokDataCompilesTheExpectedDataClass() throws Exception {
    var sources = RamPath
        .createPath("sources")
        .createFile(
            "com/github/ascopes/jct/examples/lombok/dataclass/Animal.java",
            "package com.github.ascopes.jct.examples.lombok.dataclass;",
            "",
            "import lombok.Data;",
            "",
            "@Data",
