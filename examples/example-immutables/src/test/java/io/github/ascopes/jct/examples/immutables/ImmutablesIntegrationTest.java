 ...
 */
package io.github.ascopes.jct.examples.immutables;
...
class ImmutablesIntegrationTest {
  ...
  void immutablesValueProducesTheExpectedClass(Compilable<?, ?> compiler)
    ...
    var sources = RamPath
        .createPath("sources")
        .createFile(
            "io/github/ascopes/jct/examples/immutables/dataclass/Animal.java",
            "package io.github.ascopes.jct.examples.immutables.dataclass;",
            "",
    ...
    var animalClass = compilation
        ...
        .loadClass("io.github.ascopes.jct.examples.immutables.dataclass.ImmutableAnimal");
